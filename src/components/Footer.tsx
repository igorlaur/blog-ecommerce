    ...
    <footer className="bg-gray-950 text-gray-400 py-10 mt-20">
      <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-white font-bold text-sm">Escala Digital <span className="text-orange-400">Blog</span></span>
        </div>
        <p className="text-xs text-gray-600">© {new Date().getFullYear()} Escala Digital. Todos os direitos reservados.</p>
